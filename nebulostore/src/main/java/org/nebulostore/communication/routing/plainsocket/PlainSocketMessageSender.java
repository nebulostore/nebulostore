 ...
 */
public class PlainSocketMessageSender implements MessageSender {
  private static final Logger LOGGER = Logger.getLogger(PlainSocketMessageSender.class);
  private final ExecutorService executor_;
  private final OOSDispatcher dispatcher_;
  private final CommAddressResolver resolver_;

  @Inject
  public PlainSocketMessageSender(
