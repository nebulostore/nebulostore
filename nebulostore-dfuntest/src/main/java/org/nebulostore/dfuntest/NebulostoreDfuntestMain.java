...
public final class NebulostoreDfuntestMain {
  ...
  public static void main(String[] args) {
    ...
    NebulostoreGuiceModule guiceNebulostoreModule = new NebulostoreGuiceModule();
  ...
  private static class NebulostoreGuiceModule extends AbstractModule {
    ...
    protected void configure() {
      ...
      multiBinder.addBinding().toInstance(new NebulostorePeersListTestScript());
      multiBinder.addBinding().toInstance(new NebulostoreSanityTestScript());
